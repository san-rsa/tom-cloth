...
<form onSubmit={HandleSubmit}>
            ...
            <Inputs name="street" type={"text"} onchange={handleChange} value={data.street} placeholder={"your street name "} label={"street name"}  disabled={false}  />
            <Inputs name="city" type={"text"} onchange={handleChange} value={data.city} placeholder={"city "} label={"city"}  disabled={false}  />
            <Inputs name="county" type={"text"} onchange={handleChange} value={data.county} placeholder={"county "} label={"county"}  disabled={false}  />
            <Inputs name="zipcode" type={"text"} onchange={handleChange} value={data.zipcode} placeholder={"zip code "} label={"zipcode"}  disabled={false}  />
...
export {Register, Login, ResetPassword, ForgetPassword, EditUser}